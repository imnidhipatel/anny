...
#__________________________________________task________________________________________________
# 1- greetings
# 2- personalisation 
# 3- reads system time
# 4- performs google search
...
# 9- plays  a game
# 10- toss a coin
# 11- perform simple operations on calc
# 12- takes screenshot
# 13- gives wikipedia definition
# 14 - gives you current location 
# 15 - Opens presentation on command
...
def respond(voice_data):
    ...
    if there_exists(["price of"]):
     ...
     #8 time table
        ...
        #im = Image.open(r"D:\WhatsApp Image 2019-12-26 at 10.51.10 AM.jpeg") #replace your image
        #im.show()
